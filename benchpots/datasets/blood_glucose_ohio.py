"""
Preprocessing func for the dataset Blood Glucose Ohio <2018, 2020>.
...
def preprocess_blood_glucose_ohio_2018(
    n_steps: int,
    rate: float,
    pattern: str = "point",
    features: list = None,
    **kwargs,
    ...
    """Load and preprocess the dataset Blood Glucose Ohio 2018.
    ...
    -------
    processed_dataset :
        A dictionary containing the processed Blood Glucose Ohio <2018, 2020>.

    """
    data = tsdb.load("blood_glucose_ohio_2018")
    return _preprocess_blood_glucose_ohio(data, n_steps, rate, pattern, features, **kwargs)

def preprocess_blood_glucose_ohio_2020(
    n_steps: int,
    rate: float,
    pattern: str = "point",
    features: list = None,
    **kwargs,
    ...
    """Load and preprocess the dataset Blood Glucose Ohio 2020.
    ...
    """
    data = tsdb.load("blood_glucose_ohio_2020")
    return _preprocess_blood_glucose_ohio(data, n_steps, rate, pattern, features, **kwargs)


def _preprocess_blood_glucose_ohio(
    data: dict,
    n_steps: int,
    rate: float,
    pattern: str = "point",
    ...
    **kwargs,
    ...
    main_feature = "gcb"  # feature "gcb" is the main feature of interest
